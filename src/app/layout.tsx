...
const fontClassSans = inter.variable;
const fontClassMono = sourceCodePro.variable;
...
export default function RootLayout({
  ...
  return (
    <html lang="zh-CN" className="preload-transitions js-loading">
      <head>
        {/* 内联CSS先加载，防止闪烁 */}
        ...
        {/* 预加载导航栏修复工具 */}
        <link rel="preload" href="/src/utils/navbarFix.js" as="script" />
        
        {/* 移除preload transitions类的脚本 */}
        ...
        {/* 移除js-loading类的脚本 */}
        <script dangerouslySetInnerHTML={{ __html: removeJsLoadingScript }} />
      </head>
      <body className={`${fontClassSans} ${fontClassMono} antialiased min-h-screen flex flex-col js-loading`}>
