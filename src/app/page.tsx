...
export default function Home() {
  ...
  return (
    <main className="gradient-bg">
      ...
      {/* --- Hero Section --- */}
      <section className="relative pt-24 pb-12 md:pt-32 md:pb-16 overflow-hidden w-full bg-gradient-to-br from-blue-50 via-purple-50/20 to-cyan-50 glass-morphism glass-frost">
      ...
      {/* 回到顶部按钮 */}
      <div 
        className="fixed right-8 bottom-8 z-50 group animate-float"
        style={{ opacity: 0.9 }}
      >
        {/* ... 剩余的按钮代码 ... */}
      </div>
