    ...
    <main className="gradient-bg">
          ...
          */}
          ...
          >
            <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
              每一次对话，<span className="font-bold bg-gradient-to-r from-blue-600 via-purple-500 to-cyan-500 bg-clip-text text-transparent">都是一次增长</span>
            </p>
          </motion.div>
      ...
      >
        <div className="container mx-auto px-4">
          ...
          {/* 特性卡片区域 - 使用浅蓝色背景 */}
          <div className="mx-auto max-w-4xl bg-white/30 rounded-2xl shadow-[0_20px_50px_rgba(8,112,184,0.08)] overflow-hidden border border-blue-50/60 backdrop-blur-2xl">
            {/* 全渠道在线客服 */}
            <div className="p-6 border-b border-gray-100/30 hover:bg-gradient-to-r hover:from-blue-50/40 hover:to-purple-50/40 transition-all duration-300 transform hover:scale-[1.01] backdrop-blur-lg">
              <div className="flex items-start">
                <div className="flex-shrink-0 flex items-center justify-center h-14 w-14 rounded-xl bg-gradient-to-r from-[#4e90cc] to-[#9478f0] text-white shadow-lg shadow-blue-200/70">
                  <svg
                    className="h-7 w-7"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
            ...
            {/* 大模型电话客服 */}
            <div className="p-6 hover:bg-gradient-to-r hover:from-blue-50/40 hover:to-purple-50/40 transition-all duration-300 transform hover:scale-[1.01] backdrop-blur-lg">
              <div className="flex items-start">
                <div className="flex-shrink-0 flex items-center justify-center h-14 w-14 rounded-xl bg-gradient-to-r from-[#4e90cc] to-[#9478f0] text-white shadow-lg shadow-blue-200/70">
                  <svg
                    className="h-7 w-7"
