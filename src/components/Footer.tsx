...
const Footer = ({ isFixed = false }: { isFixed?: boolean }) => {
  ...
  return (
    <footer className={`w-full ${isFixed ? 'fixed bottom-0 left-0 right-0 z-10' : 'mt-auto'}`}>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col">
              <div className="flex items-center mb-2">
                <span className="text-lg font-bold text-gray-800 tracking-tight">维普特</span>
              </div>
            ...
            <div className="flex items-start space-x-16">
              <div>
                <h4 className="text-gray-800 font-medium mb-2">公司</h4>
              ...
              <div>
                <h4 className="text-gray-800 font-medium mb-2">服务条款</h4>
                <ul className="space-y-2">
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex justify-center items-center max-w-6xl mx-auto">
              <div className="relative">
                <p className="text-gray-400 italic text-lg md:text-xl font-bold tracking-wide">
                  " Less complexity, more intelligence. "
                </p>
                <div className="absolute w-16 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 bottom-0 left-1/2 transform -translate-x-1/2 -mb-1 opacity-70"></div>
              </div>
            </div>
          </div>
        </div>
