                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <Link 
                        href="/demo"
                        onClick={handleClose}
                        className="w-full flex justify-center items-center px-6 py-3 border border-indigo-300 rounded-xl text-base font-medium text-indigo-600 bg-white hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow-sm transition-all"
                      >
                        线上体验
